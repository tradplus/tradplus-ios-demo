//
//  AdvancedNativeAdViewSampleFB.m
//  TradPlusDemo
//
...
@interface AdvancedNativeAdViewSampleFB()

@end

@implementation AdvancedNativeAdViewSampleFB
...
+ (UINib *)nibForAd
{
    return [UINib nibWithNibName:@"AdvancedNativeAdViewSampleFB" bundle:nil];
}
