//
//  AdvancedNativeAdViewSampleGG.m
//  TradPlusDemo
//
...
@interface AdvancedNativeAdViewSampleGG()

@end

@implementation AdvancedNativeAdViewSampleGG
...
+ (UINib *)nibForAd
{
    return [UINib nibWithNibName:@"AdvancedNativeAdViewSampleGG" bundle:nil];
}
